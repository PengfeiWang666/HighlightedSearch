...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/HighlightedSearchDemo"
  ...
  # Or just: s.author    = "WangPengfei"
  # s.authors            = { "WangPengfei" => "wpf_silence@163.com" }
  # s.social_media_url   = "http://twitter.com/WangPengfei"
  ...
  s.source       = { :git => "http://EXAMPLE/HighlightedSearchDemo.git", :tag => "#{s.version}" }
